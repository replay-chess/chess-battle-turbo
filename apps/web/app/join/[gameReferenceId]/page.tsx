        ...
        <div className="min-h-screen bg-cb-bg flex items-center justify-center pt-16 md:pt-24 p-4 relative">
          ...
          >
            <div className="w-16 h-16 border border-cb-border-strong flex items-center justify-center mx-auto mb-6">
              <span className="text-2xl text-cb-text-muted">×</span>
            </div>
            <h2
        ...
        >
          ...
          >
            <div className="w-16 h-16 bg-cb-accent flex items-center justify-center mx-auto mb-6">
              <Swords className="w-8 h-8 text-cb-accent-fg" strokeWidth={1.5} />
            </div>
            <h1
              style={{ fontFamily: "'Instrument Serif', serif" }}
              className="text-3xl sm:text-4xl text-cb-text"
            >
              Chess Challenge
            </h1>
          </motion.div>
          ...
          <motion.div
            ...
            className="border border-cb-border p-5 mb-6"
          >
            <p style={{ fontFamily: "'Geist', sans-serif" }} className="text-xs text-cb-text-muted uppercase tracking-widest mb-4">
              Challenge from
            </p>
            <div className="flex items-center gap-4">
              {gameDetails.creator.profilePictureUrl ? (
                ...
                <div className="w-14 h-14 bg-cb-accent flex items-center justify-center">
                  <span
                    style={{ fontFamily: "'Geist', sans-serif" }}
              ...
              <div>
                ...
                <p style={{ fontFamily: "'Geist', sans-serif" }} className="text-sm text-cb-text-muted">
                  ...
                  <div className="text-center">
                    {positionInfo.openingName ? (
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <p
                          style={{ fontFamily: "'Instrument Serif', serif" }}
                          className="text-cb-text-secondary text-sm italic"
                        >
                          {positionInfo.openingName}
                        </p>
                      </div>
                      ...
                      >
                        ...
                        <span className="text-cb-text-faint mx-1.5">vs</span>
                    ...
                    {positionInfo.tournamentName && (
                      <p
                        style={{ fontFamily: "'Geist', sans-serif" }}
                        className="text-cb-text-muted text-xs mt-1"
                      >
                        {positionInfo.tournamentName}
                      </p>
                    )}
          ...
          >
            <div className="border border-cb-border p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span style={{ fontFamily: "'Geist', sans-serif" }} className="text-xs text-cb-text-muted uppercase tracking-wide">
                  Time Control
                </span>
              </div>
              <p style={{ fontFamily: "'Instrument Serif', serif" }} className="text-2xl text-cb-text">
          ...
          {alreadyStarted && (
            ...
            >
              <p style={{ fontFamily: "'Geist', sans-serif" }} className="text-cb-text-secondary text-center text-sm">
          ...
          >
            ...
            >
              ...
              <span className={cn(
                ...
                !alreadyStarted && "group-hover:text-cb-text"
              )}>
                {joining
                  ? "Joining..."
                  : alreadyStarted
            ...
            <button
              onClick={() => router.push("/")}
              disabled={joining}
              className="w-full text-center py-2 text-cb-text-muted hover:text-cb-text-secondary transition-colors text-sm"
              style={{ fontFamily: "'Geist', sans-serif" }}
            >
              Cancel
            </button>
