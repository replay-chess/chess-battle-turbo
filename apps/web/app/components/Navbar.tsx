...
import { CreditCard, Receipt, Shield, Swords, User } from "lucide-react";
...
export const Navbar = ({ breadcrumbLabel }: { breadcrumbLabel?: string }) => {
    ...
    <>
      ...
      >
        ...
        <div className="hidden items-center gap-5 md:flex">
          {[
            { label: "Try", href: "/try" },
            { label: "Learn", href: "/learn/openings" },
            ...
            <Link
              key={item.href}
              href={item.href}
              className="font-sans text-xs uppercase tracking-[0.12em] text-cb-text-muted transition-colors hover:text-cb-text"
            >
              {item.label}
            </Link>
          ))}
            ...
            <div className="ml-2">
              <UserButton
                appearance={{
                  ...
                  elements: {
                    avatarBox:
                      "w-9 h-9 border border-cb-border-strong hover:border-cb-border-strong transition-all duration-300",
