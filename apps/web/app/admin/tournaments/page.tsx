        ...
        <div className="relative max-w-6xl mx-auto px-4 py-8 z-10">
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 border border-cb-border">
              <Trophy className="w-10 h-10 text-cb-text-faint mb-4" />
              <p style={geistFont} className="text-cb-text-muted text-sm">
                No tournaments yet
              </p>
            </div>
            ...
            <div className="space-y-3">
              {tournaments.map((t) => (
                ...
                >
                  <motion.div
                    className="border border-cb-border p-5 hover:border-cb-border-strong transition-all duration-300 cursor-pointer group"
                    whileHover={{ y: -2 }}
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 text-cb-text-muted text-xs" style={geistFont}>
